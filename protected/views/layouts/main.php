	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Download', 'url'=>array('/site/page', 'view'=>'download')),
				array('label'=>'Deploy', 'url'=>array('/site/page', 'view'=>'deploy')),
				array('label'=>'Bugs/Patches', 'url' => 'https://github.com/colyii'),
